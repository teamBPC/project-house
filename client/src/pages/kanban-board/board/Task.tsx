...
import { IBoardProps, IToDo } from "../../../interface/kanbanBoard";
import { IBtnRefState, IModalState } from "../../../interface/modal";
import { modalHandle } from "../../../libs/modalHandle";
import TaskDetailModal from "../../../components/modal/task/task-detail-modal/TaskDetailModal";

function Task({ boardItem, index }: IBoardProps) {
