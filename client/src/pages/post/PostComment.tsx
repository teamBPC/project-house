function PostComment() {
  return (
    <div className="grid grid-cols-10 w-[1400px] gap-4">
      <div className="col-span-7">
        <div className="flex items-start gap-4 p-4 pb-6 border-b-2">
          <img
          ...
          {[1, 2, 3, 4, 5].map((list) => (
            <div key={list} className="flex items-start gap-2 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold">baek-si-hyun</span>
      ...
      <div className="flex flex-col col-span-3 gap-4">
        <div className="flex items-center gap-2 p-6 bg-slate-50">
          <img
            className="w-10 h-10 rounded-full"
            src={`https://imagedelivery.net/4aEUbX05h6IovGOQjgkfSw/f7fa91bd-bd76-4274-5220-e796e1565100/avatar`}
            alt="avatar"
